...
public class Upload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(filekey);*/
				...
				String fullpath=editpath+"CC\\WebContent\\local\\";
			...
			//file encrypted and store into filepath1
		             ...
		             filepath1 = editpath + "\\CC\\WebContent\\Encrypt\\"+filename;
		              ...
		              //file decrypted and store into filepath2
		        		    ...
		        		    filepath2 = editpath + "\\CC\\WebContent\\Decrypt\\"+filename;
		     ...
		     filepath1 = editpath + "\\CC\\WebContent\\Encrypt\\"+filename;
		      ...
		      //file decrypted and store into filepath2
				 ...
				 upb.setFileowner(paramValues.get(0).toString());
		         System.out.println("Ownername"+paramValues.get(0).toString());
		               
		         upb.setCategory(paramValues.get(2).toString());
		          System.out.println("Category"+paramValues.get(2).toString());
		                
		          upb.setFilekey(paramValues.get(4).toString());
		          System.out.println("Secretkey"+paramValues.get(4).toString());
