...
<head>
	...
	<meta charset="UTF-8" />
	<meta name="keywords"
		content="Natural Responsive web template, Bootstrap Web Templates,Motorola web design" />
	<script>
	...
	<link rel="stylesheet" href="css15/bootstrap.css">
	<link rel="stylesheet" href="css15/style.css" type="text/css" media="all" />
	<link href="css15/font-awesome.min.css" rel="stylesheet">
	<link
		...
		<div class="banner_w3lspvt">
			<div class="nav_w3ls pt-4 pb-3 text-center">
				<nav>
					...
					<ul class="menu">
						<li><a href="">Home</a></li>
						<li><a href="Fileaccept.jsp">Inbox</a></li>
