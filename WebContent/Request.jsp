...
PreparedStatement p = d.prepareStatement("SELECT * FROM blockchain.fileupload WHERE Status='Accepted'");
...
<td><%=filename%></td>  
<td><%=filetype%></td>
<td align="left"><a href="Filerequest?fname=<%=filename%>&&ftype=<%=filetype%>&&key=<%=filekey%>"><button>SEND <br> REQUEST</button></a></td>
